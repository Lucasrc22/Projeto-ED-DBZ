...
#com o grafo construido, foi atribuido o metodo para carregar os nós, arestas e 
#planos de fundo com imagens .png
...
#destaque para personagem que for vilão principal ser vermelho no grafo plotly
    ...
    plt.show()
#Calcula o caminho de menor custo entre Goku e seus aliados
#Medido de modo inverso, quanto menor peso, maior o custo
...
#Trilha da onde o Goku consegue seguir suas conexões, tanto
...
#vai visitando os nós vizinhos, não significa que é uma ordem
def bfs(G, origem):
...
#Teste de Script mas não implementado, se daria certo
